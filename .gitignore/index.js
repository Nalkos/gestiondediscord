...
client.login("NDk3OTM5MzMyOTY4MjE4NjI0.DppMYw.QXWyhFu_1aIiWQ0o_okLAgsIj-M");

client.on("ready", () => {
    console.log("Je suis prêt !")
    client.user.setGame("rien car je suis un bot")
});
...
client.on('message', message => {
    ...
    if(message.content === prefix + "aide"){
        ...
        .setDescription("Je suis un bot de test")
        .addField("*aide", "Affiche les commandes du bot")
        .addField("Bonjour", "Le bot répond !")
        .addField("*statistiques", "le bot vous envoie des information sur votre profil !")
        .addField("*info", "Donne des information sur le bot et le serveur")
    ...
    if(message.content === prefix + "help") {
      ...
      if(message.content === prefix + "mod") {
        ...
        .setFooter("Commande de modération ")
        .setTimestamp()
    ...
    if(message.content.startsWith(prefix + "clear")) {
        ...
        message.channel.bulkDelete(args[0]).then(() => {
            message.channel.send(`${args[0]} messages on été supprimés !`);
        })
    }

    if(message.content.startsWith(prefix + "mute")) {
        if(!message.guild.member(message.author).hasPermission("ADMINISTRATOR")) return message.channel.send("Vous n'aver pas la permission !");
        ...
        if(!message.guild.member(client.user).hasPermission("ADMINISTRATOR")) return message.channel.send("Je n'ai pas la premission !");
    ...
    switch (args[0].toLowerCase()) {
        ...
        .setThumbnail(message.author.avatarURL)
        message.reply("Tu peux regarder tes messages privés ! tu vien de recevoir tes stattistique !")
